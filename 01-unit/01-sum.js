...
try {
  ...
  var result = sum(4, null);
  if (result !==4) throw new Error('Expected sum(4, 0) to be 4. Received: ' + result);
  // --------------------------------------------------
  // Test Case 4
  // --------------------------------------------------
  // When invoked with no numbers, it should return 0.
  var result = sum(null, null);
  if (result !==0) throw new Error('Expected sum(0, 0) to be 0. Received: ' + result);
